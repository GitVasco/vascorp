            ...
            ?>
                ...
                <li class="treeview <?php if (
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?php if ($_GET["ruta"] == "modelo-color-taller") echo 'active'; ?>">
                            <a href="modelo-color-taller">

                                <i class="fa fa-circle-o"></i>
                                <span>Taller modelo</span>
            ...
            ?>
                <li class="treeview <?php if (
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?php if ($_GET["ruta"] == "mp-recetas") echo 'active'; ?>">

                            <a href="mp-recetas">

                                <i class="fa fa-book text-orange"></i>
                                <span> MP en recetas</span>
