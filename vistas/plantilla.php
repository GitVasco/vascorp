...
<head>
    ...
    if (isset($_GET["ruta"])) {
        ...
        } elseif ($_GET["ruta"] === "utilidades") {
            $__tituloVentana = "Utilidades | Vasco System";
  ...
  ======================================-->
    ...
    <link rel="stylesheet" href="vistas/css/dashboard-gerencial.css?v=19">
    <?php endif; ?>
    ...
    <link rel="stylesheet" href="vistas/css/reportes-generales-v2.css?v=9">
    <?php } ?>
    <?php endif; ?>
    ...
    <link rel="stylesheet" href="vistas/css/helpdesk.css?v=33">
    <?php endif; ?>
...
<body class="hold-transition skin-black sidebar-collapse sidebar-mini login-page">
        ...
        if (isset($_GET["ruta"])) {
            ...
            if (
                ...
                if (!function_exists("usuarioPuedeVerModulo") || !usuarioPuedeVerModulo("gestion_comercial", "dashboard_cxc")) {
                    ...
                    include "modulos/dashboard-cxc.php";
                }
    ...
    <script src="vistas/js/dashboard-gerencial.js?v=23"></script>
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "dashboard-cxc") { ?>
    ...
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "informe-semanal-vendedor") { ?>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.0/dist/chart.umd.min.js"></script>
    <script src="vistas/js/informe-semanal-vendedor.js?v=11"></script>
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "sync-vasco") { ?>
    ...
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "cuadre-ventas") { ?>
    <script src="vistas/js/cuadre-ventas.js?v=46"></script>
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "regularizaciones-comerciales") { ?>
    ...
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "helpdesk") { ?>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.0/dist/chart.umd.min.js"></script>
    <script src="vistas/js/helpdesk.js?v=52"></script>
    <script src="vistas/js/helpdesk-indicadores.js?v=7"></script>
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "utilidades") { ?>
    <script src="vistas/js/utilidades.js?v=32"></script>
    <?php } ?>
    <?php if (isset($_GET["ruta"]) && $_GET["ruta"] == "reportes-generales-v2") { ?>
