...
<body>
    ...
    */
    ...
    if ($linea == "1") {
        ...
        $vendedor = "'00','00A','00B','01','02','03','04','05','06','06A','06B','07','07A','08','08C','08D','08DR','08L','14','15','19','21','22','22A','23','25','27'";
    } else if ($linea == "2") {
        $logo = "rosaflor.png";
        $vendedor = "'18','18A','24','26','28'";
    } else {
        $logo = "jackyform_paloma2.png";
        $vendedor  = "'00','00A','00B','01','02','03','04','05','06','06A','06B','07','07A','08','08C','08D','08DR','08L','14','15','18','19','21','22','22A','23','25','18A','24','26','27'";
    }
