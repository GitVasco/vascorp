...
class TablaPedidosCVVendedores
{

    /*=============================================
    MOSTRAR LA TABLA DE PEDIDOS FILTRADOS POR VENDEDOR
    =============================================*/

    public function mostrarTablaPedidosCVVendedores()
    {

        $pedidos = ControladorPedidos::ctrMostraPedidosGeneralVendedores();
...
=============================================*/
$activarArticulosPedidos = new TablaPedidosCVVendedores();
$activarArticulosPedidos->mostrarTablaPedidosCVVendedores();
