...
class ModeloArticulos
{
	...
	*/
	...
	{
		if ($sectorIngreso == "T4" || $sectorIngreso == "T6" || $sectorIngreso == "T9" || $sectorIngreso == "T2" || $sectorIngreso == "T8" || $sectorIngreso == "T0" || $sectorIngreso == "TA" || $sectorIngreso == "T7" || $sectorIngreso == "T10" || $sectorIngreso == "TB" || $sectorIngreso == "T11" || $sectorIngreso == "T14" || $sectorIngreso == "TD" || $sectorIngreso == "TE" || $sectorIngreso == "T12") {
